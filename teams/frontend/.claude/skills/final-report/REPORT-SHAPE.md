...
Two to five sentences: the surface and states you shipped. State any assumption you made on an
...
literal result line. For this lane that means the component suite, browser tests, and backend/e2e when they exist.
