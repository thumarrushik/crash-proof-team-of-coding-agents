---
name: final-report
description: The frontend lane's REPORT.md — what was built, how it was verified with exact commands, every file accounted for. Use when ending any run in this lane.
---

# final-report (frontend lane)
...
2. Factual, few sentences per section, no filler; the surface and states you shipped.
