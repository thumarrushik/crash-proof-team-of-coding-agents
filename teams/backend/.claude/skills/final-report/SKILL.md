---
name: final-report
description: The backend lane's REPORT.md — what was built, how it was verified with exact commands, every file accounted for. Use when ending any run in this lane.
---

# final-report (backend lane)
...
2. Factual, few sentences per section, no filler; the endpoint/schema behavior you shipped.
