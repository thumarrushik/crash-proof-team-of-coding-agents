...
Two to five sentences: the endpoint/schema behavior you shipped. State any assumption you made on an
...
literal result line. For this lane that means the full suite plus frontend/e2e when they exist.
