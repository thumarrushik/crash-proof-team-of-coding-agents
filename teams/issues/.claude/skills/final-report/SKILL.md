---
name: final-report
description: The issues lane's REPORT.md — what was changed, how it was verified with exact commands, every file accounted for. Use when ending any run in this lane.
---

# final-report (issues lane)
...
2. Factual, few sentences per section, no filler; the issue's acceptance line and the smallest change that closed it.
