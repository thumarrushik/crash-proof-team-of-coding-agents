---
name: final-report
description: The testing lane's REPORT.md — what was covered, how it was verified with exact commands, every file accounted for. Use when ending any run in this lane.
---

# final-report (testing lane)
...
2. Factual, few sentences per section, no filler; the promises your new tests pin and the ones they found broken.
