...
*The code and every results file cited live in the repository, [github.com/thumarrushik/crash-proof-team-of-coding-agents](https://github.com/thumarrushik/crash-proof-team-of-coding-agents): the system under `src/`, the lanes under `teams/`, the runs and `quickstart.sh` under `deploy/`.*
