...
*This is the mechanism half. The claims, the numbers, and the fine print —
one engineer, a cheap fast model, single-digit runs, point estimates — live in
the flagship and apply verbatim here.*
...
- [A Crash-Proof Team of Coding Agents](a-crash-proof-team-of-coding-agents.md) — the flagship: the kill, the costs, the conflict that resolved itself
